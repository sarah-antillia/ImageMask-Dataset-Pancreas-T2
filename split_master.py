...
def split_master(images_dir, masks_dir, output_dir, format=".jpg"):
  image_files = glob.glob(images_dir + "/*" + format)
...
if __name__ == "__main__":
  try:
    images_dir = "./Pancreas-T2-master/images/"
    masks_dir  = "./Pancreas-T2-master/masks/"
    output_dir = "./Pancreas-T2-ImageMaskDataset-V1/"
